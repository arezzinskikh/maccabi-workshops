...
const WORKSHOPS = [
  {
    ...
    title: 'מכבי קל 10',
    description: 'קבוצה לירידה במשקל, שינוי הרגלי אכילה ואורח חיים בליווי דיאטנית',
    registration_link: '#',
    sort_order: 1,
  },
  {
    categorySlug: 'nutrition',
    title: 'מכבי קל – המשך',
    description: 'קבוצת המשך לקבוצת מכבי קל לשמירה על משקל תקין, הרגלי אכילה ואורח חיים בריא',
    registration_link: '#',
    sort_order: 2,
  },
  {
    ...
    description: 'תכנית לשיפור אורח חיים בריא אצל ילדים ונוער בעלי עודף משקל בליווי צוות מקצועי',
    registration_link: '#',
    sort_order: 3,
  },
  {
    ...
    description: 'תוכנית ייחודית של 4 מפגשים לנשים בהריון: תזונה נכונה בהריון, ויטמינים, מינרלים ותוספים',
    registration_link: '#',
    sort_order: 4,
  },
  {
    ...
    description: 'קבוצת תמיכה לגמילה מעישון בליווי מקצועי. מפגשים שבועיים, כלים מעשיים, וסביבה תומכת',
    registration_link: '#',
    sort_order: 1,
  },
  {
    ...
    description: 'פגישות אישיות עם מומחה לגמילה מעישון, תוכנית מותאמת אישית לפי צרכים וקצב האדם',
    registration_link: '#',
    sort_order: 2,
  },
  {
    categorySlug: 'family',
    title: 'זוגיות בריאה',
    description: 'סדנה לחיזוק הקשר הזוגי ושיפור התקשורת בין בני הזוג, בהנחיית מטפל זוגי',
    registration_link: '#',
    sort_order: 1,
  },
  {
  ...
  },
  {
    ...
    description: 'תוכנית 8 מפגשים לניהול סוכרת סוג 2: תזונה, פעילות גופנית, ניטור ועוד',
    registration_link: '#',
    sort_order: 1,
  },
  {
    categorySlug: 'diabetes',
    title: 'מניעת סוכרת',
    description: 'סדנה לאנשים בסיכון גבוה לסוכרת. למידה על שינוי אורח חיים למניעת המחלה',
    registration_link: '#',
    sort_order: 2,
  },
  {
    ...
    description: 'תכנית פעילות גופנית מותאמת לגיל השלישי: חיזוק שרירים, שיווי משקל וגמישות',
    registration_link: '#',
    sort_order: 1,
  },
  {
    ...
    description: 'סדנת אורח חיים בריא לגיל הזהב: תזונה, פעילות גופנית ורווחה נפשית',
    registration_link: '#',
    sort_order: 2,
  },
];
