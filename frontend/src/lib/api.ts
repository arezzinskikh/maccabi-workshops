...
export const FALLBACK_WORKSHOPS: Record<string, Workshop[]> = {
  ...
  'family': [
    ...
    makeWorkshop(14, 'נגיעה-בהורות-עיסוי-תינוקות', 'נגיעה בהורות – עיסוי תינוקות', 'סדנה להורים לעיסוי תינוקות וחיזוק הקשר בין ההורה לתינוק על ידי מגע', 'family', `${BASE}/2024/08/%D7%A0%D7%92%D7%99%D7%A2%D7%94-%D7%91%D7%94%D7%95%D7%A8%D7%95%D7%AA-%D7%9E%D7%95%D7%91%D7%99%D7%99%D7%9C.webp`),
  ],
  'diabetes': [
    makeWorkshop(15, 'אורח-חיים-בריא-בסוכרת', 'אורח חיים בריא בסוכרת', 'סדנה ללמידה כיצד לאמץ אורח חיים בריא עם סוכרת: תזונה, פעילות גופנית, תרופות וכלים לחיים עם המחלה', 'diabetes', `${BASE}/2024/08/%D7%90%D7%95%D7%A8%D7%97-%D7%97%D7%99%D7%99%D7%9D-%D7%91%D7%A8%D7%99%D7%90-%D7%A2%D7%9D-%D7%A1%D7%95%D7%9B%D7%A8%D7%AA-%D7%93%D7%A1%D7%A7%D7%98%D7%95%D7%A4.webp`),
    makeWorkshop(16, 'אורח-חיים-בריא-בסוכרת-מפות-שיח', 'אורח חיים בריא בסוכרת – בשיטת מפות שיח', 'סדנה ייחודית המעניקה ידע וכלים להתמודדות עם סוכרת דרך שיח פתוח בקבוצות קטנות', 'diabetes', `${BASE}/2024/08/%D7%A1%D7%95%D7%9B%D7%A8%D7%AA-2-%D7%9E%D7%95%D7%91%D7%99%D7%99%D7%9C_1.webp`),
  ],
  'seniors': [
    makeWorkshop(17, 'שיפור-ושימור-הזיכרון', 'שיפור ושימור הזיכרון ואורח חיים בריא בגיל השלישי', 'סדנה של 7 מפגשים המעניקה ידע וכלים מעשיים לשיפור ושימור הזיכרון ולשמירה על אורח חיים בריא בגיל השלישי', 'seniors', `${BASE}/2025/01/shutterstock_1354254773-scaled.jpg`),
